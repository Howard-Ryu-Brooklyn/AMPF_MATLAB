...
z12=vecnorm(pos0(:,1)-pos0(:,2));
z13=vecnorm(pos0(:,1)-pos0(:,3));
z23=vecnorm(pos0(:,2)-pos0(:,3));

fprintf("distance at inital position between agent is shown as below\n");
fprintf("z12: %2.2f,  z13: %2.2f,  z23: %2.2f \n\n", z12, z13, z23);